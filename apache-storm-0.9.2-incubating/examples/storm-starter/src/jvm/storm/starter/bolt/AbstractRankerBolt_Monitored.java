 ...
 * <p/>
 * It uses a template method design pattern for {@link AbstractRankerBolt_Monitored#execute(Tuple, BasicOutputCollector)} to allow
 ...
 */
public abstract class AbstractRankerBolt_Monitored extends BaseBasicBolt {
  ...
  public AbstractRankerBolt_Monitored() {
    this(DEFAULT_COUNT, DEFAULT_EMIT_FREQUENCY_IN_SECONDS);
  }

  public AbstractRankerBolt_Monitored(int topN) {
    this(topN, DEFAULT_EMIT_FREQUENCY_IN_SECONDS);
  }

  public AbstractRankerBolt_Monitored(int topN, int emitFrequencyInSeconds) {
    if (topN < 1) {
  ...
  public final void execute(Tuple tuple, BasicOutputCollector collector) {
    ...
    collector.emit("abstract_ranker_bolt_PT_stream",new Values(process_time));
  }
  ...
  public void declareOutputFields(OutputFieldsDeclarer declarer) {
    ...
    declarer.declareStream("StreamOne", new Fields("rankings"));
	declarer.declareStream("abstract_ranker_bolt_PT_stream", new Fields ("process time"));
  }
