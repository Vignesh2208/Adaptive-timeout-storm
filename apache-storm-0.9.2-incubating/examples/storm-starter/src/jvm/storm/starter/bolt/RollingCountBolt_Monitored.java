 ...
 */
public class RollingCountBolt_Monitored extends BaseRichBolt {

  private static final long serialVersionUID = 5537727428628598519L;
  private static final Logger LOG = Logger.getLogger(RollingCountBolt_Monitored.class);
  ...
  public RollingCountBolt_Monitored() {
    this(DEFAULT_SLIDING_WINDOW_IN_SECONDS, DEFAULT_EMIT_FREQUENCY_IN_SECONDS);
  }

  public RollingCountBolt_Monitored(int windowLengthInSeconds, int emitFrequencyInSeconds) {
  ...
  public void execute(Tuple tuple) {
    ...
    collector.emit("rolling_count_bolt_PT_stream",new Values(process_time));
  }
  ...
  private void emit(Map<Object, Long> counts, int actualWindowLengthInSeconds) {
    for (Entry<Object, Long> entry : counts.entrySet()) {
      ...
      collector.emit("StreamOne",new Values(obj, count, actualWindowLengthInSeconds));
    }
  }
  ...
  public void declareOutputFields(OutputFieldsDeclarer declarer) {
	...
	declarer.declareStream("StreamOne", new Fields("obj", "count", "actualWindowLengthInSeconds"));
	declarer.declareStream("rolling_count_bolt_PT_stream", new Fields ("process time"));
  }
