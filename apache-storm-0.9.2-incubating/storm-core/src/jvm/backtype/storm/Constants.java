...
public class Constants {
    ...
    public static final String SYSTEM_TIMEOUT_STREAM_ID = "Timeout stream";
    public static final String TIMEOUT_FILE_BASE_DIR = "/app/home/storm/";
    public static final String ACKER_COMP_ID = "__acker";
    public static final String SPOUT_COMPUTED_TIMEOUT_STREAM_ID = "Spout-timeout-stream";
    public static final double ADAPT_PARAMETER = 0.8;
    //Kiran
    public static final int MAX_TIMEOUT = 100;
    public static final int DEFAULT_TIMEOUT = 100;
    public static final float TIMEOUT_PERCENTILE = (float) 0.95;
    public static final float NETWORK_DELAY = (float) 0.25;
}
