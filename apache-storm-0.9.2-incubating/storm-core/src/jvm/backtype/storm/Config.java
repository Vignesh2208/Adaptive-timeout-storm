...
public class Config extends HashMap<String, Object> {
    ...
    */
    ...
    /**
     * For switching between different timeout modes
     * 
     */
    
    public static final String ADAPTIVE_TIMEOUT_ENABLED="Adaptive.timeout.enabled";
    public static final Object ADAPTIVE_TIMEOUT_ENABLED_SCHEMA = Boolean.class;

    public static final String ADAPTIVE_TIMEOUT_MODE="Adaptive.timeout.mode";
    public static final Object ADAPTIVE_TIMEOUT_MODE_SCHEMA = String.class;
    
    public static final String BASE_DIR_NAME="base.dir.name";
    public static final Object BASE_DIR_NAME_SCHEMA = String.class;
    
    public static final String TOPOLOGY_SPECIFIC_INFO="topology.specific.info";
    public static final Object TOPOLOGY_SPECIFIC_INFO_SCHEMA = String.class;

    
    public static final String FAULT_INJECTOR_ENABLED ="fault.injector.enabled";
    public static final Object FAULT_INJECTOR_ENABLED_SCHEMA = Boolean.class;
    
    public static final String MSG_DROP_PROBABILITY ="msg.drop.probability";
    public static final Object MSG_DROP_PROBABILITY_SCHEMA = Number.class;
    
    public static final String DEBUG_LOG_ENABLED="Debug.log.enabled";
    public static final Object DEBUG_LOG_ENABLED_SCHEMA = Boolean.class;
    
    public static final String DEBUG_PRINT_ENABLED="Debug.print.enabled";
    public static final Object DEBUG_PRINT_ENABLED_SCHEMA = Boolean.class;
    ...
    */
    ...
    public static void setDebugLogEnabled(Map conf, boolean isOn) {
        conf.put(Config.DEBUG_LOG_ENABLED, isOn);
    } 
    
    public static void setDebugPrintEnabled(Map conf, boolean isOn) {
        conf.put(Config.DEBUG_PRINT_ENABLED, isOn);
    } 
    ...
    public void setDebugLogEnabled(boolean isOn) {
        setDebugLogEnabled(this, isOn);
    }
    
    public void setDebugPrintEnabled(boolean isOn) {
        setDebugPrintEnabled(this, isOn);
    }
   ...
   /**
    * Related to adaptive timeout
    */
    
   public static void DisableAdaptiveTimeout(Map conf){
	   conf.put(Config.ADAPTIVE_TIMEOUT_ENABLED,false);
   }
   
   public void DisableAdaptiveTimeout(){
	   DisableAdaptiveTimeout(this);
   }
   ...
   public static void EnableFaultInjector(Map conf,int sample_size){
	   ...
	   conf.put(Config.FAULT_INJECTOR_ENABLED,true);
	   conf.put(Config.MSG_DROP_PROBABILITY,sample_size);
	   
   }
   
   
   public void EnableFaultInjector(int sample_size){
	   EnableFaultInjector(this,sample_size);
   }
   
   /**
    * Other already builtin functions
    */
