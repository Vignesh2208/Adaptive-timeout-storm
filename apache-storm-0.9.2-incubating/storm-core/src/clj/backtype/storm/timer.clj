...
(defn schedule-refresh-recurring
 [timer timeout_computation_fn file-name function_to_be_recalled]
(schedule timer
          (timeout_computation_fn file-name)
          (fn this []
            (function_to_be_recalled)
            (schedule timer (timeout_computation_fn file-name) this :check-active false)))
