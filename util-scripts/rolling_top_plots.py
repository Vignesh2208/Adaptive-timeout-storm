...
n_fails_with = [0,0,0,21395,252538]
n_acks_with = [105471,164336,209117,211938,6606]
n_emitted_tuples_with = [105471,164336,209117,211939,39350]
...
n_fails_without = [0,0,0,199211,185465]
n_acks_without = [87785,149613,184830,7184,3440]
n_emitted_tuples_without = [87785,149613,184859,116594,121273]
...
base_file_dir = "/home/vignesh/Desktop/END_to_END/Rolling_Count_topology"
...
with open("Rolling_Count_topology_arrays_END_to_END.txt",'w') as f :
